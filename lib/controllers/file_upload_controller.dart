...
class FileUploadController {
  ...
  // upload picked image file to the firebase storgae bucket in the given path
  Future<String> uploadFile(File file, String folderPath) async {
    try {
      // getting the file name from the file path
      final String fileName = basename(file.path);

      // defining the firabase storage destination where the file should be uploaded to
